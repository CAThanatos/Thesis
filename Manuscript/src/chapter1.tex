...
\section{Introduction}
  ...
  \subsection{Individual-Based Modeling and Evolutionary Robotics}
    ...
    -> Application ER pour social behaviours et evol de manière générale

    -> Application ER pour evol coopération
    ...
    Floreano2010 -> Evolution of altruism
  ...
  \subsection{Problematique et justification des choix oui lol}
    % Garder ça pour après quand on justifie notre choix
    % However, one thing that should now be clear is that we do not claim that any model fundamentally better than the others. In the contrary, and even if there has been a progression in the way we deal with evolutionary processes, each model is useful in its own way to study a particular problem given a set of assumptions and a level of abstraction.
    % Figure Mitri
