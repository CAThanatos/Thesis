...
We now investigate the evolution of division of labour between heterogeneous robots by way of genotypic polymorphism. Our results are presented as a published article in an international conference:

\begin{quote}
  \fullquote{Bernard2016b}
\end{quote}


In the previous Chapter we showed that considering the nature of coordination strategies in addition to the probability to evolve cooperation was beneficial to the design of cooperative robots. In particular, we revealed that a particular heterogeneous approach, cooperative coevolution, led to the emergence of a very efficient coordination behaviour: leader/follower. This behaviour entails the evolution of task specialisation (or division of labour). Here we focus on the evolution of a leader/follower strategy in a single population of individuals. As the issue of evolving cooperation in evolutionary robotics is often solved with homogeneous robots, division of labour must be achieved during the life of the individuals. This means that specialisation then relies on phenotypical plasticity of environmental cues. 

Here we are interested in evolving specialisation without this additional mechanisms. This means division of labour must be achieved at the level of the population. In consequence, we want to investigate the maintenance of several different genotypes encoding for different roles in a single population. This is called genotypic polymorphism. In particular, we focus on the impact of the selection strategy on evolving division of labour.

To that end, we use a simpler foraging task than the one presented in Chapter~\ref{chapter:C2_article1}. Two genetically different individuals are placed in arena where they can collect a single type of targets. This target is more rewarding when collected in a cooperative manner. This means that evolving cooperation is easy (we are not interested in the issue of evolving cooperation here) but more importantly that this task if favored by the evolution of efficient coordination strategies. As we showed in the previous Chapter, two different cooperative strategies can evolve in this setting. On the one hand, there is the turner strategy, where both individuals adopt the same behaviour to coordinate. Therefore this is a generalist behaviour. On the other hand, they can also evolve specialist behaviours and adopt a leader/follower strategies. We are interested on studying two the influence of two selection schemes: (1) a \((\mu + \lambda)\)-ES (elitist) selection strategy and (2) fitness-proportionate selection. We also study the impact of varying population size.

We reveal that specialisation is nearly impossible to evolve under an elitist selection strategy. Indeed, in only one replication under high population size are specialists present in the population at the end of the simulation. Surprisingly however, specialists do evolve during multiple replications but are never maintained. When the population is initially seeded with specialists, similar results are observed. However, results are different with fitness-proportionate selection. While specialists are nearly never bootstrapped, they are easily maintained throughout evolution (especially when starting with a population of specialists). We thus reveal that evolving genotypic polymorphism is hindered by the challenge of both bootstrapping an maintaining specialists in the population and that none of these two classical strategy are able to achieve this.

We then use computational analyses to have a deeper understanding of the underlying dynamis at play. We show that while specialists are the most efficient, generalists can invade the population because they fare quite good against any other phenotype. In comparison, when specialists are paired with other specialists of the same type, their performance is very low. Additional analyses show that, under finite population size, genetic diversity can be lost from one generation to the other. This can, especially under small population sizes, lead to the disappearance of specialists from the population. We thus highlight two critical properties for the evolution of genotypic polymorphism: (1) protection against the invasion of generalists and (2) maintenance of genotypic diversity. We argue that an algorithm endowed with such properties would ensure the evolution of genotypic polymorphism.





% TODO: Gaffe cette version de l'article est pas la dernière !
\section{Evolving Specialisation in a Population of Heterogeneous Robots: the Challenge of Bootstrapping and Maintaining Genotypic Polymorphism}
  \subsection{Introduction}
    ...
    We design a 2-robots cooperative foraging task where both a solitary and a cooperative strategies can evolve but where cooperation is highly rewarded. The genotype of each robotic agent is separately chosen in the population and the individuals therefore form an heterogeneous group. This task is greatly favored by the evolution of efficient coordination strategies. In particular, our previous work on a similar task~\parencite{Bernard2015} showed that two types of cooperative strategy could evolve: one where both individuals adopt homogeneous behaviours (generalists) and the other one where they adopt a leader/follower strategy (specialists). As the latter is the more efficient one we study the conditions for its emergence. The evolutionary dynamics of two popular selection methods are studied: (1) an elitist \((\mu + \lambda)\) selection scheme and (2) a fitness-proportionate selection scheme. Fitness-proportionate in particular is interesting with regards to genotypic polymorphism as it is known to allow the evolution of frequency-dependent selection~\parencite{Altenberg1991}.
