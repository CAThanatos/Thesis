...
\section{Going Beyond the Evolvability vs. Efficiency Tradeoff using Incremental Evolution}
  ...
  \subsection{Waypoints Crossing Task}  
    ...
    \begin{figure}[h]
      \centering
        \begin{subfigure}[]
          {\label{fig:leadershipControl} \includegraphics[scale=0.25]{fig/ArticleRob1/proportionLeadershipControl.pdf}}
        \end{subfigure}
        \begin{subfigure}[]
          {\label{fig:leadershipClonal} \includegraphics[scale=0.25]{fig/ArticleRob1/proportionLeadershipClonal.pdf}}
        \end{subfigure}
        \begin{subfigure}[]
          {\label{fig:leadershipCoevo} \includegraphics[scale=0.25]{fig/ArticleRob1/proportionLeadershipCoevo.pdf}}
        \end{subfigure}
