...
\section{Introduction}
  ...
  \subsection{Cooperative Robots for Collective Tasks}
    ...
    Biological inspiration more obvious for swarm

    -> Biological inspiration (Cao) == Swarm ?

    -> Swarm (dire que c'est ça quand on parle de collective robotics (et dire que ça peut être troublant))
          -> Parler de la distinction qu'en fait Parker dans Parker2008

    -> self-organization

    -> Dire que coopération c'est à la base des MRS en fait
        -> Et mentionner la coordination
        Tout ça peut arriver en dernier paragraphe (pour bien justifier que c'est ce à quoi on s'intéresse)
