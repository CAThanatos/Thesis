...
\section{Introduction}
  ...
  \subsection{Evolving Cooperative Robots}
    ...
    -> Va falloir parler du fait d'utiliser des heterogeneous robots. Ca a l'air d'être plus courant que prévu

    -> Mentionner novelty-search quelque part ?

    STANLEY2011 pour quelques ER références mais pas plus
