...
\section{Introduction}
  ...
  \subsection{Cooperative Robots for Collective Tasks}
    \begin{itemize}
      \item{Where we justify the need to have cooperation between robots (if it has not been said in Intro.III.3)}
    \end{itemize}
